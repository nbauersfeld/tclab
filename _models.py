...
# ode batch helper
# builds y0, t, y, i per batch 
# stepwise data lookup
class HelperODE():

    @staticmethod
    def batch_(t, y, batch_time, batch_size, data_size):
        ...
        return batch_y0, batch_t, batch_y, batch_i
...
class SurrogateODE(tf.keras.Model):
    ...
    def call(self,t,y):
        return getattr(self, self.mode)(t,y)       
